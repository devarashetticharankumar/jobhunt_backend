...
function transformDescription(
  ...
  transformed += `
    ...
    <p>Your work as a ${jobTitle} will directly contribute to ${companyName}’s success. From spearheading key initiatives to refining systems, you’ll have the autonomy to innovate and the resources to succeed. This role offers a platform to showcase your expertise and grow your career in ${jobLocation}. Ready to dive in? <b>Apply today</b> and start making an impact!</p>

    <h2><b>Qualifications & Skills: What You’ll Bring</b></h2>
    <p>We’re searching for a ${jobTitle} who’s ready to hit the ground running. Here’s what we expect from you to excel in this role:</p>
    <ul style="margin: 0; padding-left: 20px; line-height: 1.2;">
  `;

  if (scrapedSkills.length > 0) {
    scrapedSkills.forEach((skill) => {
      transformed += `<li>✔ ${skill.label}</li>`;
    });
  } else {
    transformed += `
      <li>✔ A degree or equivalent experience in a relevant field</li>
      <li>✔ Proven expertise that makes you stand out as a ${jobTitle}</li>
      <li>✔ Strong analytical and communication skills for impactful results</li>
      <li>✔ A proactive approach to problem-solving and innovation</li>
      <li>✔ Advanced technical skills or certifications (preferred)</li>
      <li>✔ Experience with cutting-edge methodologies (preferred)</li>
    `;
  }

  transformed += `
    </ul>
    <p>We value more than just skills—we want someone with curiosity, adaptability, and a passion for collaboration. If you’re eager to learn, propose bold ideas, and grow with ${companyName}, this ${jobTitle} role in ${jobLocation} is for you. <b>Show us what you’ve got—apply now!</b></p>

    <h2><b>Why Join ${companyName}? Perks That Inspire</b></h2>
    <p>Great talent deserves great rewards. At ${companyName}, we’ve crafted a benefits package to keep you motivated and supported:</p>
    <ul style="margin: 0; padding-left: 20px; line-height: 1.2;">
      <li>💰 $${minPrice}–$${maxPrice}—a standout package for top performers</li>
      <li>🎯 Performance Bonuses to celebrate your achievements</li>
      <li>🏥 Comprehensive Health Plans—medical, dental, and vision</li>
      <li>📈 Retirement Savings with company matching</li>
      <li>🌿 Flexible Work Options—hybrid or remote where possible</li>
      <li>📚 Learning Opportunities—courses, workshops, and more</li>
      <li>🏖 Generous Paid Time Off to recharge</li>
      <li>🎉 Team Events for connection and fun</li>
    </ul>
    ...
    <p>Got questions about this ${jobTitle} role? We’ve got you covered:</p>
    <h3><b>❓ What’s the pay like?</b></h3>
    <p>$${minPrice}–$${maxPrice}, plus bonuses tied to your performance and company milestones. It’s a package designed to reward your skills.</p>
    <h3><b>❓ Can I work remotely?</b></h3>
    <p>Yes, depending on the role and location. We offer hybrid and remote options to fit your life in ${jobLocation}.</p>
    <h3><b>❓ What skills matter most?</b></h3>
    <p>Technical prowess, teamwork, and communication are key for a ${jobTitle} at ${companyName}. Bring these, and you’ll thrive.</p>
    ...
    <p>This ${jobTitle} role in ${jobLocation} is your chance to shine with ${companyName}. We’re building a team of innovators, and we want you on board. Don’t miss out—positions fill fast, and early applicants get priority. <b>Apply today</b> to kickstart your journey!</p>
    ...
    <p>${companyName} is more than a job—it’s a mission. We’re driven by innovation, inclusivity, and sustainability, and we’re looking for a ${jobTitle} to join us in ${jobLocation}.</p>
    <ul style="margin: 0; padding-left: 20px; line-height: 1.2;">
      <li>🌍 Inclusive Culture: Diversity fuels our success</li>
      <li>🔬 Cutting-Edge Projects: Shape the future</li>
      <li>💡 Career Growth: Upskill and advance</li>
      <li>🌱 Sustainability: Build a better tomorrow</li>
    </ul>
...
//     <h2><b>About ${companyName}: Innovate with Purpose</b></h2>
//     <p>At ${companyName}, we’re more than just a company—we’re a global force committed to excellence, sustainability, and transformative technology. As a ${jobTitle}, you’ll be at the forefront of groundbreaking initiatives, working with state-of-the-art tools and collaborating with industry experts. Our mission is to improve lives through innovation, and we need talented professionals like you to make it happen.</p><br>
//     <p>Why choose ${companyName}? Because we offer a workplace where your ideas matter, your growth is prioritized, and your contributions shape the future. From ${jobLocation}, you’ll join a team that values diversity, creativity, and excellence. Curious about what’s in store? Keep reading to discover why this ${jobTitle} role is your next big career move.</p>

//     <h2><b>📍 Why ${jobLocation}? A Perfect Blend of Work and Life</b></h2>
//     <p>${jobLocation} isn’t just a job location—it’s a lifestyle destination. Known for its thriving tech community, stunning scenery, and unbeatable quality of life, this region is a magnet for professionals seeking career growth and personal fulfillment. As a ${jobTitle} at ${companyName}, you’ll enjoy a workplace that balances productivity with well-being.</p><br>
//     <p>From modern office spaces to hybrid work options, ${jobLocation} offers flexibility that suits your needs. The area boasts a rich cultural scene, excellent schools, and endless recreational opportunities—perfect for professionals and families alike. Relocating? You’ll find a welcoming community ready to support your transition. <b>Learn more</b> about ${jobLocation} and see why it’s the ideal place to advance your ${jobTitle} career.</p>
//     <ul style="margin: 0; padding-left: 20px; line-height: 1.2;">
//       <li>✔ Thriving tech hub with endless collaboration opportunities</li>
//       <li>✔ Scenic beauty and a balanced lifestyle</li>
...
//       const url = `https://www.glassdoor.com/Job/${location
//         .toLowerCase()
//         .replace(
//           / /g,
//           "-"
